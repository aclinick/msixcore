    ...
    public static int Run(IReadOnlyList<string> args, TextWriter output, TextWriter error)
    {
            ...
            out string? parseError))
        {
            CliContract.WriteError(
                ...
                "msixkit pack",
                parseError!,
                "Usage: msixkit pack <sourceDir> -o|--output <file.msix> [--compress] [--overwrite] [--json]");
        ...
        {
            CliContract.WriteError(output, error, json, "msixkit pack", ex.Message, null, CliContract.ErrorCode(ex));
