...
| Transactional staging + rollback | [Managing MSIX deployment](https://learn.microsoft.com/en-us/windows/msix/desktop/managing-your-msix-deployment-overview) | yes | `FileSystemPackageStore.CommitLocked` | Move-aside backup + atomic promote; restores prior installs on failure; a store lock file serializes writers across processes. |
