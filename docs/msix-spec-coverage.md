...
| Transactional staging + rollback | [Managing MSIX deployment](https://learn.microsoft.com/en-us/windows/msix/desktop/managing-your-msix-deployment-overview) | yes | `FileSystemPackageStore.CommitLocked`, `DurableFileSystem` | An integrity-checked intent journal plus POSIX directory `fsync` / Windows write-through renames orders and recovers interrupted transactions. |
