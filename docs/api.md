...
| `void Commit(string stagingLocation, InstalledPackageInfo package, DeploymentOptions options)` | Promote verified staging with family/version policy, rollback, and a cross-process store lock. |
