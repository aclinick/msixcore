...
| `void Commit(string stagingLocation, InstalledPackageInfo package, DeploymentOptions options)` | Promote verified staging with fail-closed family/version policy, a cross-process lock, and crash-recovery journal. |
